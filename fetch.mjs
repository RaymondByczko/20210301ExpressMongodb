async function fetchDelete(users_id, validate) {
    debugger;
...
async function validateDelete(response) {
    ...
    if (responseClone.status !== "200") {
        throw new Error("status is:" + responseClone.status);
    }
}
...
if (typeof exports !== 'undefined') {
    ...
    exports.fetchUserAll = fetchUserAll;
    exports.alertFetchResponse = alertFetchResponse;
    */
}
//else {
...
// }
/*
module.exports.fetchDelete = fetchDelete;
